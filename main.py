...
class App:
    ...
    def process_webcam(self):
        ...
        imgtk = ImageTk.PhotoImage(self.most_recent_capture_pil)
    ...
    def login(self):
        ...
        if name == 'no_persons_found':
            message = "No persons were found. Please register or try again."
        elif name == 'unknown_person':
            message = 'Unknown user, register or try again.'
        else:
        ...
        util.msg_box('Result', message)
        self.speak_message(message)  # Speak the message
    ...
    def accept_register_new_user(self):
        ...
        message = 'User {} has been registered successfully!'.format(name)
        util.msg_box('Added', message)
        self.speak_message(message)  # Speak the message
        self.register_new_user_window.destroy()
